...
static const struct pios_mpu9250_cfg pios_mpu9250_cfg = {
	...
	.interrupt_cfg = PIOS_MPU60X0_INTEN_DATA_RDY,
...
void PIOS_Board_Init(void) {
	...
	if (PIOS_Flash_Jedec_Init(&pios_external_flash_id, pios_spi_flash_id, 0, &spi_flash_cfg) != 0) {
                panic(1);
        }
	...
	PIOS_MS5611_SPI_Init(pios_spi_sensors_id, 1, &pios_ms5611_cfg);
...
#if defined(PIOS_INCLUDE_MPU9250_SPI)
	if (PIOS_MPU9250_SPI_Init(pios_spi_sensors_id, 0, &pios_mpu9250_cfg) != 0) {
                panic(3);
        }
