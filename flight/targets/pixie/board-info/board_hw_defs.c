...
/* 
 * SPI3 Interface
 * Used for MPU9250 IMU and MS5611 pressure sensor
 */
...
static const struct pios_flash_jedec_cfg spi_flash_cfg = {
	.expect_manufacturer = 0xC2,
...
#if defined(PIOS_INCLUDE_FLASH_JEDEC)
static const struct pios_flash_sector_range ex_flash_sectors[] = {
	{
		.base_sector = 0,
		.last_sector = 63,
		.sector_size = FLASH_SECTOR_64KB,
...
static const struct pios_flash_chip pios_flash_chip_external = {
	...
	.page_size     = 256,
	.sector_blocks = ex_flash_sectors,
	.num_blocks    = NELEMENTS(ex_flash_sectors),
};
#endif /* PIOS_INCLUDE_FLASH_JEDEC */
...
static const struct pios_flash_partition pios_flash_partition_table[] = {
...

	{
		...
		.size         = (63 - 16 + 1) * FLASH_SECTOR_64KB,
	},
#endif	/* PIOS_INCLUDE_FLASH_JEDEC */
};
...
// Timers used for outputs (2, 3, 8, 8)
...
static const TIM_TimeBaseInitTypeDef tim_2_4_8_time_base = {
...
static const struct pios_tim_clock_cfg tim_2_cfg = {
	.timer = TIM2,
	.time_base_init = &tim_2_4_8_time_base,
	.irq = {
		.init = {
